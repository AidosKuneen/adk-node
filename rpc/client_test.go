...
// This test reproduces https://github.com/aidoskuneen/adk-node/issues/17837 where the
...
// It is the reproducer for https://github.com/aidoskuneen/adk-node/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("adkgo-test-ipc-%d-%d", os.Getpid(), rand.Int63())

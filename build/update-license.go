...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/aidoskuneen/adk-node/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of adkgo authors for copyright purposes.\n\n"
)

...
import (
	...
	"github.com/aidoskuneen/adk-node/crypto/signify"
	"github.com/aidoskuneen/adk-node/internal/build"
	...
	*workdir = makeWorkdir(*workdir)
	...
	for _, pkg := range debPackages {
		for distro, goboot := range debDistroGoBoots {
			// Prepare the debian package with the adkgo sources.
...
type debMetadata struct {
	...
	// adkgo version being built. Note that this
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/aidoskuneen/adk-node/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/aidoskuneen/adk-node/mobile")

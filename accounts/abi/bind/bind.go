...
//
// Detailed usage document and tutorial available on the adkgo Wiki page:
// https://github.com/aidoskuneen/adk-node/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
